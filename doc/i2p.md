...
The first time Groestlcoin Core connects to the I2P router, if
...
file named `i2p_private_key` in the Groestlcoin Core data directory. The persistent
...
If an I2P node is not accepting incoming connections, then Groestlcoin Core uses
