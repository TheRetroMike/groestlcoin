...
```
$ python3 contrib/tracing/p2p_monitor.py ./build/src/groestlcoind
```
...
```
$ python3 contrib/tracing/log_raw_p2p_msgs.py ./build/src/groestlcoind
```
...
```bash
$ python3 contrib/tracing/log_utxocache_flush.py ./build/src/groestlcoind
```
...
```console
$ python3 contrib/tracing/mempool_monitor.py ./build/src/groestlcoind
```
